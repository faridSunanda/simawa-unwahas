...
Route::middleware(['auth', 'role:kemahasiswaan'])->prefix('kemahasiswaan')->name('kemahasiswaan.')->group(function () {
    Route::get('/dashboard', function () {
        ...
        Route::put('/jenis-sertifikat/{jenisSertifikat}', [JenisSertifikatController::class , 'update'])->name('jenis-sertifikat.update');
        Route::delete('/jenis-sertifikat/{jenisSertifikat}', [JenisSertifikatController::class , 'destroy'])->name('jenis-sertifikat.destroy');
        // Verifikasi Pendaftaran Kegiatan
        Route::get('/verifikasi-kegiatan', [\App\Http\Controllers\Kemahasiswaan\VerifikasiKegiatanController::class , 'index'])->name('verifikasi-kegiatan.index');
        Route::get('/verifikasi-kegiatan/{kegiatanPeserta}', [\App\Http\Controllers\Kemahasiswaan\VerifikasiKegiatanController::class , 'show'])->name('verifikasi-kegiatan.show');
        Route::post('/verifikasi-kegiatan/{kegiatanPeserta}/verify', [\App\Http\Controllers\Kemahasiswaan\VerifikasiKegiatanController::class , 'verify'])->name('verifikasi-kegiatan.verify');

        // Kegiatan CRUD
        Route::get('/kegiatan', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'index'])->name('kegiatan.index');
        Route::post('/kegiatan', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'store'])->name('kegiatan.store');
        Route::put('/kegiatan/{kegiatan}', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'update'])->name('kegiatan.update');
        Route::delete('/kegiatan/{kegiatan}', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'destroy'])->name('kegiatan.destroy');

        // Kegiatan - Peserta
        Route::get('/kegiatan/{kegiatan}/peserta', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'peserta'])->name('kegiatan.peserta');
        Route::put('/kegiatan/peserta/{peserta}/presensi', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'updatePresensi'])->name('kegiatan.peserta.presensi');

        // Kegiatan - QR Presensi
        Route::get('/kegiatan/{kegiatan}/scan-presensi', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'scanPresensi'])->name('kegiatan.scan-presensi');
        Route::post('/kegiatan/{kegiatan}/process-qr', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'processQrPresensi'])->name('kegiatan.process-qr');

        // Kegiatan - Rundown
        Route::get('/kegiatan/{kegiatan}/rundown', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'rundown'])->name('kegiatan.rundown');
        Route::post('/kegiatan/{kegiatan}/rundown', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'storeRundown'])->name('kegiatan.rundown.store');
        Route::put('/kegiatan/rundown/{rundown}', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'updateRundown'])->name('kegiatan.rundown.update');
        Route::delete('/kegiatan/rundown/{rundown}', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'destroyRundown'])->name('kegiatan.rundown.destroy');

        // Kegiatan - Sertifikat
        Route::get('/kegiatan/{kegiatan}/sertifikat', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'sertifikat'])->name('kegiatan.sertifikat');
        Route::post('/kegiatan/{kegiatan}/sertifikat', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'uploadSertifikat'])->name('kegiatan.sertifikat.upload');
        Route::delete('/kegiatan/{kegiatan}/sertifikat', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'deleteSertifikat'])->name('kegiatan.sertifikat.delete');
        Route::get('/kegiatan/{kegiatan}/sertifikat/preview', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'previewSertifikat'])->name('kegiatan.sertifikat.preview');
        Route::get('/kegiatan/peserta/{peserta}/download-sertifikat', [\App\Http\Controllers\Kemahasiswaan\KegiatanController::class , 'downloadSertifikatPeserta'])->name('kegiatan.peserta.download-sertifikat');
    });
...
Route::middleware(['auth', 'role:mahasiswa'])->prefix('mahasiswa')->name('mahasiswa.')->group(function () {
    Route::get('/dashboard', function () {
        ...
        Route::get('/kegiatan/{kegiatan}/form', [KegiatanMahasiswaController::class , 'form'])->name('kegiatan.form');
