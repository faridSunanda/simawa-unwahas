    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
            ...
            <div class="p-5">
                @if($kegiatan->sertifikat_template)
                    ...
                    <div class="mb-4 p-4 bg-green-50 border border-green-200 rounded-xl">
                        ...
                        <div class="flex flex-wrap gap-2 mt-3">
                            ...
                            <form action="{{ route('kemahasiswaan.kegiatan.sertifikat.delete', $kegiatan) }}" method="POST"
                ...
                <!-- Upload Form -->
                <form action="{{ route('kemahasiswaan.kegiatan.sertifikat.upload', $kegiatan) }}" method="POST"
            ...
            <div class="p-5">
                ...
                @if($kegiatan->sertifikat_template)
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <a href="{{ route('kemahasiswaan.kegiatan.sertifikat.preview', $kegiatan) }}?name=Nama%20Peserta%20Contoh&nim=1234567890"
                            target="_blank"
                                ...
                                @foreach($pesertaHadir as $index => $p)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <a href="{{ route('kemahasiswaan.kegiatan.peserta.download-sertifikat', $p) }}"
